...
export const OrganizerApp: React.FC<OrganizerAppProps> = ({
  ...
  else if (pathname.includes('/organizer/orders') || pathname.includes('/organizer/attendees') || pathname.includes('/organizer/tickets')) initialTab = 'orders';
  else if (pathname.includes('/organizer/scanner') || pathname.includes('/organizer/check-ins')) initialTab = 'scanner';
  else if (pathname.includes('/organizer/settings') || pathname.includes('/organizer/team') || pathname.includes('/organizer/finance') || pathname.includes('/organizer/billing')) initialTab = 'settings';
